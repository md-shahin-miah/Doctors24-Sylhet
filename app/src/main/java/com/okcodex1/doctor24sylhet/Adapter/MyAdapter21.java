...
public class MyAdapter21 extends RecyclerView.Adapter<MyAdapter21.Myholder> {
    ...
    public MyAdapter21(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter21.Clicklistener clicklistener){
        MyAdapter21.clicklistener=clicklistener;
    }
