...
public class MyAdapter20 extends RecyclerView.Adapter<MyAdapter20.Myholder> {
    ...
    public MyAdapter20(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter20.Clicklistener clicklistener){
        MyAdapter20.clicklistener=clicklistener;
    }
