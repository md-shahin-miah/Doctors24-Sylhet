...
public class MyAdapter17 extends RecyclerView.Adapter<MyAdapter17.Myholder> {
    ...
    public MyAdapter17(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter17.Clicklistener clicklistener){
        MyAdapter17.clicklistener=clicklistener;
    }
