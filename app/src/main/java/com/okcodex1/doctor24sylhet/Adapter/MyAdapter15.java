...
public class MyAdapter15 extends RecyclerView.Adapter<MyAdapter15.Myholder> {
    ...
    public MyAdapter15(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter15.Clicklistener clicklistener){
        MyAdapter15.clicklistener=clicklistener;
