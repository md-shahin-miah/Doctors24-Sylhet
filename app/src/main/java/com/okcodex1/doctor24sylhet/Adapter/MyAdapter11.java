...
public class MyAdapter11 extends RecyclerView.Adapter<MyAdapter11.Myholder> {
    ...
    public MyAdapter11(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter11.Clicklistener clicklistener){
