...
public class MyAdapter10 extends RecyclerView.Adapter<MyAdapter10.Myholder> {
    ...
    public MyAdapter10(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter10.Clicklistener clicklistener){
