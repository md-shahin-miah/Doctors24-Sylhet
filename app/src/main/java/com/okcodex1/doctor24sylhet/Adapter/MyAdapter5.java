...
public class MyAdapter5 extends RecyclerView.Adapter<MyAdapter5.Myholder> {
    ...
    public MyAdapter5(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter5.Clicklistener clicklistener){
