...
public class MyAdapter12 extends RecyclerView.Adapter<MyAdapter12.Myholder> {
    ...
    public MyAdapter12(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter12.Clicklistener clicklistener){
