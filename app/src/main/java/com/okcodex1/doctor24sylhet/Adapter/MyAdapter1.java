...
public class MyAdapter1 extends RecyclerView.Adapter<MyAdapter1.Myholder> {
    ...
    public MyAdapter1(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter1.Clicklistener clicklistener){
        MyAdapter1.clicklistener=clicklistener;
    }
