...
public class MyAdapter16 extends RecyclerView.Adapter<MyAdapter16.Myholder> {
    ...
    public MyAdapter16(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter16.Clicklistener clicklistener){
        MyAdapter16.clicklistener=clicklistener;
    }
