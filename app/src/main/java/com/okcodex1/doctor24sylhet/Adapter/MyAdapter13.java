...
public class MyAdapter13 extends RecyclerView.Adapter<MyAdapter13.Myholder> {
    ...
    public MyAdapter13(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter13.Clicklistener clicklistener){
