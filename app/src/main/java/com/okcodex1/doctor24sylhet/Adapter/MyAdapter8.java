...
public class MyAdapter8 extends RecyclerView.Adapter<MyAdapter8.Myholder> {
    ...
    public MyAdapter8(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter8.Clicklistener clicklistener){
