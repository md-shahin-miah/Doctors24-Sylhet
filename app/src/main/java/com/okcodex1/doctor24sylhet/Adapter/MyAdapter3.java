...
class MyAdapter3 extends RecyclerView.Adapter<MyAdapter3.Myholder> {
    ...
    public MyAdapter3(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter3.Clicklistener clicklistener){
