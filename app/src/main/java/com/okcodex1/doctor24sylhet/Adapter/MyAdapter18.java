...
public class MyAdapter18 extends RecyclerView.Adapter<MyAdapter18.Myholder> {
    ...
    public MyAdapter18(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener(MyAdapter18.Clicklistener clicklistener){
        MyAdapter18.clicklistener=clicklistener;
    }
