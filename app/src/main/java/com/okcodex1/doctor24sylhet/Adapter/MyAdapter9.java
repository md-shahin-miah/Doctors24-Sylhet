...
class MyAdapter9 extends RecyclerView.Adapter<MyAdapter9.Myholder> {
    ...
    public MyAdapter9(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter9.Clicklistener clicklistener){
