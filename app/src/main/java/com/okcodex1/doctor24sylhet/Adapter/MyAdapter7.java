...
public class MyAdapter7 extends RecyclerView.Adapter<MyAdapter7.Myholder> {
    ...
    public MyAdapter7(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter7.Clicklistener clicklistener){
