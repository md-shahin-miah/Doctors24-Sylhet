...
public class MyAdapter14 extends RecyclerView.Adapter<MyAdapter14.Myholder> {
    ...
    public MyAdapter14(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter14.Clicklistener clicklistener){
        MyAdapter14.clicklistener=clicklistener;
    }
