...
public class MyAdapter4 extends RecyclerView.Adapter<MyAdapter4.Myholder> {
    ...
    public MyAdapter4(Context context, List<Modelclass> list) {
    ...
    public void setOnItemClickListener (MyAdapter4.Clicklistener clicklistener){
